...
import { getTreasures } from "~/models/card.server";
...
export type LoaderData = {
  cards: Awaited<ReturnType<typeof getTreasures>>;
};

export const loader: LoaderFunction = async ({ request, params }) => {
  const url = new URL(request.url);
  const cards = await getTreasures(toFilter(url.searchParams));
